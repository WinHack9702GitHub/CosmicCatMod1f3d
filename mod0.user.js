...
document.cosmicCat.Utils.waitForElm("head").then(() => {
    ...
    x.setAttribute("href", "https://web.archive.org/web/20091113001227if_/http://www.youtube.com/favicon.ico");
    document.querySelector("head").append(x);

    var u = document.createElement("link");
    u.setAttribute("rel", "shortcut icon");
    u.setAttribute("href", "https://web.archive.org/web/20091113001227if_/http://www.youtube.com/favicon.ico");
    document.querySelector("head").append(u);

    // Doesn't always load on FF
    document.cosmicCat.Utils.addStyle("https://web.archive.org/web/20091112150648cs_/http://s.ytimg.com/yt/cssbin/www-core-vfl132161.css");
});
...
<style id="fix-hid">.hid {display: none !important;}</style>`;
        ...
        document.cosmicCat.Utils.waitForElm2().then(() => {
            (!0 === update) && document.cosmicCat.Alert(0, "An update is available to Cosmic Cat! <a href=\"mod0.user.js">Click to install it.</a>");
        });
